...
<body>
    ...
    <div class="slideshow-container">
        ...
        <a class="prev" onclick="changeSlide(-1)" style="text-decoration: none;">&#10094;</a>
        <a class="next" onclick="changeSlide(1)" style="text-decoration: none;">&#10095;</a>
    </div>
    <br>
    ...
    <div class="w3-grid-template">
        ...
        foreach ($rows as $book) {
            ...
            echo "<div class='w3-center w3-padding-small' style='height: 420px;'>
                    <div class='w3-card w3-round-large' style='height: 100%; display: flex; flex-direction: column;'>
                        ...
                        <div class='w3-description' style='flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;'>
                            <h6 class='book-title' style='margin-top: 10px;'><a href='bookdetails.php?bookid=$bookid'>$book_title</a></h6>";

            if ($book_qty == 0) {
                echo "<p style='color: red; font-size: 18px; margin-bottom: 25px;'>Out of Stock</p>";
            } else {
                echo "<p>RM " . number_format($book_price, 2) . " / $book_qty avail</p>
